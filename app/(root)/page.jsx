// Copyright (C) 2025 vivek Bilyunazra
// This file is part of Vivek -porto-2-nextJs.
...
import Me from "@/public/image/vivek.png";
import Me5 from "@/public/image/me5.jpeg";
// import Me from "@/public/image/vivek.png";
import Setup from "@/public/image/setup.jpg";
import Hr from "@/components/Hr";
import Project from "@/public/image/Capture.png";
// icons
				...
				<div className="mx-auto w-[82%] max-w-screen-2xl grid grid-cols-1 md:grid-cols-3 gap-4 p-10 overflow-hidden">
					<motion.div
						...
						<motion.p
							...
							Hi! I&rsquo;am Vivek, A fullstack software
							engineer specializing in modern Web Development with
							a growing focus on Artificial Intelligence. I
							architect scalable, efficient, and user-friendly applications that solve real-world problems. With a passion for learning and
							innovation, I am dedicated to creating impactful
							solutions that drive progress in the tech industry.
						</motion.p>
						<motion.div
					...
					<div className="z-0 mb-48 md:mb-0 md:absolute md:top-1/2 md:right-[10%] md:-translate-y-1/2">
						...
						>
							<Image
								src={Me5}
								alt="Alvalens"
								width={500}   // 👈 small width
								height={500}  // 👈 keep aspect ratio (or use original ratio)
				...
				<div className="relative md:h-screen w-screen  gap-4 p-10 flex justify-center items-center flex-col overflow-hidden">
					...
					<div className="z-10 w-full absolute md:w-auto  md:left-[10%] top-[60%] md:top-1/3 col-span-2 flex flex-col justify-center items-start md:items-start text-start px-10 overflow-hidden">
						...
						<motion.p
							...
							<a href="mailto:vivek2000vivek@gmail.com?subject=Hello&body=Hello Vivek ,">
								vivek2000vivek@gmail.com
							</a>
						</motion.p>
						{/* icons */}
						<div className="flex justify-center items-center space-x-4">
							<motion.a
								href="mailto:vivek2000vivek@gmail.com?subject=Hello&body=Hello Vivek ,"
							...
							<motion.a
								href="https://www.instagram.com/__vivek20?igsh=MWRtNTZyOGpxYmlhdA=="
								target="_blank"
								rel="noopener noreferrer"
								className="flex justify-center items-center bg-gray-700 w-14 h-14 rounded-full text-gray-100 hover:bg-gray-400 transition-all ease-in-out duration-300"
								initial={{ opacity: 0, y: 40 }}
							...
							<motion.a
								href="https://www.linkedin.com/in/vivek-kumar-b826b516b/"
								target="_blank"
								rel="noopener noreferrer"
								className="flex justify-center items-center bg-gray-700 w-14 h-14 rounded-full text-gray-100 hover:bg-gray-400 transition-all ease-in-out duration-300"
								initial={{ opacity: 0, y: 40 }}
